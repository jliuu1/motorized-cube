...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA4     ------> ADC_IN4
    */
    GPIO_InitStruct.Pin = VBATT0_Pin|VBATT1_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA4     ------> ADC_IN4
    */
    HAL_GPIO_DeInit(GPIOA, VBATT0_Pin|VBATT1_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM21_MspInit 0 */
    ...
    PA11     ------> TIM21_CH2
    */
    GPIO_InitStruct.Pin = MTR_FB_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_TIM21;
    HAL_GPIO_Init(MTR_FB_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = MTR3_PWM_Pin|MTR4_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = MTR5_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF5_TIM2;
    HAL_GPIO_Init(MTR5_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM22_MspPostInit 0 */
    ...
    PA10     ------> TIM22_CH2
    */
    GPIO_InitStruct.Pin = MTR1_PWM_Pin|MTR2_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM21_MspDeInit 0 */
    ...
    PA11     ------> TIM21_CH2
    */
    HAL_GPIO_DeInit(MTR_FB_GPIO_Port, MTR_FB_Pin);
